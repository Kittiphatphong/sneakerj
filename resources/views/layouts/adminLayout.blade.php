                            ...
                            <div class="topbar-item">
                                <div class="btn btn-icon w-auto d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                                    <div class="d-flex text-right pr-3">
                                        ...
                                        <span class="text-white font-weight-bolder font-size-sm d-none d-md-inline">{{ucfirst(Auth::user()->name)}}</span>
                                    </div>
                                    <div class="dropdown">
                                    <span class="symbol symbol-35" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
												<span class="symbol-label font-size-h5 font-weight-bold text-white bg-white-o-15">{{substr(ucfirst(Auth::user()->name), 0, 1)}}</span>
											</span>
                    ...
                    <div class="container">
                        ...
                        <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                            ...
                            <div id="kt_header_menu" class="header-menu header-menu-left header-menu-mobile header-menu-layout-default">
                                <!--begin::Header Nav-->
                                <ul class="menu-nav">
                                    <li class="menu-item @isset($dashboard) menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here @endisset" aria-haspopup="true">
                                        <a href="{{route('dashboard')}}" class="menu-link">
                                            <span class="menu-text ">Dashboard</span>
                                        </a>
                                    </li>
                                    <li class="menu-item @isset($products) menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here @endisset" aria-haspopup="true">
                                        <a href="{{route('product.index')}}" class="menu-link">
                                            <span class="menu-text ">Product</span>
                                        </a>
                                    </li>
                                    <li class="menu-item @isset($brands) menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here @endisset" aria-haspopup="true">
                                        <a href="{{route('brand.index')}}" class="menu-link">
                                            <span class="menu-text ">Brand</span>
                                        </a>
                                    </li>
                                    <li class="menu-item menu-item-submenu menu-item-rel @if(isset($color)|| isset($size) || isset($type)) menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here @endif" data-menu-toggle="click" aria-haspopup="true">
                                        ...
                                        <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                            <ul class="menu-subnav">
                                                ...
                                                <li class="menu-item @isset($color) menu-item-active @endisset" aria-haspopup="true">
                                                ...
                                                <li class="menu-item @isset($size) menu-item-active @endisset" aria-haspopup="true">
                                                ...
                                                <li class="menu-item @isset($type) menu-item-active @endisset" aria-haspopup="true">
