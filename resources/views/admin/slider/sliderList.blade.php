            ...
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                <div class="card-title">
                    <h3 class="card-label">Sliders
                        <span class="d-block text-muted pt-2 font-size-sm">Slider list</span></h3>
                </div>
            ...
            <div class="card-body">
                ...
                <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                    ...
                    <tr>
                        <td>{{$slider->id}}</td>
                        <td>
<img src="{{$slider->image}}" width="250px">
                        </td>
                        ...
                        <td>
                            <div class="d-flex justify-content-start">
                                ...
                                <form action="{{route('slider.destroy',$slider->id)}}" method="post" class="delete_form" >
                                    @csrf
